...
describe("Button.svelte", () => {
  ...
  // If I remove the `onclick` event forwarding code from the Button component, then this test will fail, which means that the event forwarding is working properly.
