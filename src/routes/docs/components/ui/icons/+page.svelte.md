...
You have to update the `src/assets/styles/icons.css` file with any new icons that you want to use.
...
2. Run `node generate-css-icons.js` or `make generate-css-icons` from the root directory. This will overwrite the `src/assets/styles/icons.css` file with the latest CSS code.
